...
?>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Tax Station Admin List</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table sakotable table-bordered table-striped dt-responsive">
                ...
                <tbody>
                  <?php
			$result = mysql_query("SELECT *,a.added_date as p_addted_date,b.branch_name from tbl_add_uadmin a inner 
			join tblbranch b on b.branch_id = a.branch_id order by a.aid DESC",$link);
