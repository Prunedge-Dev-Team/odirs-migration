	...
	?>
		...
		<?php 
	//$sql = "select * FROM tblcategory WHERE branch_id = '$_SESSION[branchId]'";
	$sqlx ="select * from applicant_login";
	$res_custx = mysqli_query($conn, $sqlx);
	$num_rows_custx = mysqli_num_rows($res_custx);
	   ...
	   <!-- ./col end -->
		<div class="col-lg-3 col-xs-6">
		  <div class="small-box bg-yellow">
			...
			<a href="list_paye_application.php" class="small-box-footer"><?php echo $_data['dashboard_more_info']; ?> <i class="fa fa-arrow-circle-right"></i></a></div>
		</div>
		<!-- ./col end -->
		...
		<!--div class="col-lg-4 col-xs-6">
		  <div class="small-box bg-yellow">
			...
			<a href="upload_file1.php" class="small-box-footer"><?php echo $_data['dashboard_more_info']; ?> <i class="fa fa-arrow-circle-right"></i></a> </div>
		...
		<div class="col-lg-4 col-xs-6">
		  <div class="small-box bg-yellow">
			<div class="inner">
			    <h3><?php echo $num_rows_cust ; ?></h3>
			  <h4>
				<?php echo $_data['dashboard_view_returns']; ?></h4>
			  <p>&nbsp;</p>
			</div>
			<div class="icon"> <img height="50" width="50" src="img/room.png"></a> </div>
			<a href="applicant_details.php" class="small-box-footer"><?php echo $_data['dashboard_more_info']; ?> <i class="fa fa-arrow-circle-right"></i></a> </div>
		</div>
		<!-- ./col end -->
		...
		<div class="col-lg-4 col-xs-6">
		  <div class="small-box bg-yellow">
			<div class="inner">
			  <h3><?php echo $num_rows_custx ; ?></h3>
			  <p><?php echo $_data['dashboard_view_returns']; ?></p>
			</div>
