        ...
        <?php  
          ...
          <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
                <?php
			$first_sub_total = 0;
			$sql = "Select * FROM tblreturns WHERE week LIKE 'First%' AND created_date LIKE '%/05/2020%' AND branch_id = " . (int)$_SESSION['branchId']. " ";
          ...
          <div class="box-body">
            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
                <?php
			$second_sub_total = 0;
			$sql = "Select * FROM tblreturns WHERE week LIKE 'Second%' AND created_date LIKE '%/05/2020%' AND branch_id = " . (int)$_SESSION['branchId']. " ";
            	$result = $conn->query($sql);
				while($row = $result->fetch_assoc()) {   
          ...
          <div class="box-body">
            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
                <?php
			$third_sub_total = 0;
      $sql = "Select * FROM tblreturns WHERE week LIKE 'Third%' AND created_date LIKE '%/05/2020%' AND branch_id = " . (int)$_SESSION['branchId']. " ";
            	$result = $conn->query($sql);
				while($row = $result->fetch_assoc()) {   
          ...
          <div class="box-body">
            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
                <?php
			$fourth_sub_total = 0;
      $sql = "Select * FROM tblreturns WHERE week LIKE 'Fourth%' AND created_date LIKE '%/05/2020%' AND branch_id = " . (int)$_SESSION['branchId']. " ";
            	$result = $conn->query($sql);
				while($row = $result->fetch_assoc()) {   
          ...
          <div class="box-body">
            <table style="font-size:13px;" class="table sakotable table-bordered table-striped dt-responsive">
              ...
              <tbody>
                <?php
			$fifth_sub_total = 0;
			$sql = "Select * FROM tblreturns WHERE week LIKE 'Fifth%' AND created_date LIKE '%/05/2020%' AND branch_id = " . (int)$_SESSION['branchId']. " ";
            	$result = $conn->query($sql);
				while($row = $result->fetch_assoc()) {   
...
<div align="center"><a class="btn btn-primary btn_save" onClick="javascript:print('printable','ODIRS - May 2020 Returns Summary');" 
