...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="<?php echo WEB_URL?>/s_a_dashboard.php"><i class="fa fa-dashboard"></i> <?php echo $_data['text_1'];?></a></li>
