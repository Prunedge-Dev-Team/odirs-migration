<?php include('a_header.php'); ?>
	...
	if(isset($_GET['id']) && $_GET['id'] != '' && $_GET['id'] > 0){
		$sqlx= "DELETE FROM `paye_applicant` WHERE id = ".$_GET['id'];
	  ...
	  <div class="col-xs-12">
		...
		<div class="box box-info">
		  <div class="box-header">
			<h3 class="box-title"><?php echo $_data['paye_payer_info'];?></h3>
		  </div>
		  <!-- /.box-header -->
		  <div class="box-body">
			...
			<div class="table-responsive download-table">
			  ...
			  <th><?php echo $_data['add_new_form_field_text_15'];?></th>
			  ...
			  <tbody>
                ...
                $sql= "SELECT * from  paye_applicant";
					  ...
					  <div class="modal-dialog">
						<div class="modal-content">
						  <div class="modal-header orange_header">
							...
							<h3 class="modal-title"><?php echo $_data['paye_payer_info'];?></h3>
						  </div>
						  ...
						  <div class="modal-body">
							...
							<div class="row">
							  ...
							  <b><?php echo $_data['add_new_form_field_text_11'];?> :</b> <?php echo $row['name']; ?><br/> 
                            <b><?php echo $_data['add_new_form_field_text_12'];?> :</b> <?php echo $row['email']; ?><br/>
                            <b><?php echo $_data['add_new_form_field_text_13'];?> :</b> <?php echo $row['address']; ?><br/>
							<b><?php echo $_data['add_new_form_field_text_14'];?> :</b> <?php echo $row['phone']; ?><br/> 
                            <b><?php echo $_data['add_new_form_field_text_15'];?> :</b> <?php echo $row['appNo']; ?><br/>
                            <b><?php echo $_data['add_new_form_field_text_16'];?> :</b> <?php echo $row['reg_date']; ?><br/>
	...
	function deleteReturns(Id){
		var iAnswer = confirm("Are you sure you want to delete this PAYE Record ?");
		if(iAnswer){
			window.location = 'applicant_details.php?id=' + Id;
		}
	  }
