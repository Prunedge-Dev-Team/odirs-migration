	...
	<aside class="main-sidebar">
	  ...
	  <section class="sidebar" style="margin-top:10px;">
		...
		<ul class="sidebar-menu">
		  ...
		  <li class="<?php if($page_name != '' && $page_name == 'dashboard'){echo 'active';}?>"><a href="a_dashboard.php">
		  ...
		  <i class="fa fa-empire"></i> <span><?php echo $_data['menu_cat_information']; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
			...
			<li class="<?php if($page_name != '' && $page_name == 'catlist'){echo 'active';}?>"><a href="list_paye_application.php">
			<i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_cat_list']; ?></a></li>
			  <li class="<?php if($page_name != '' && $page_name == 'addcat'){echo 'active';}?>"><a href="applicant_details.php">
		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
			  ...
			  <div class="form-group">
				...
				<input type="text" class="form-control" id="txtProfileName" name="txtProfileName" value="<?php
				//$sql = "select * from paye_applicant  where r_id = '".$_SESSION["user_id"]."'";
				$sql = "select * from admin ";
				$query=$conn->query($sql);
				while($row=mysqli_fetch_array($query))
				{
